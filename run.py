...
parser.add_argument('--model', type=str, default='FiSSM', help='model name, options: [Autoformer, Informer, Transformer]')
...
# optimization
parser.add_argument('--num_workers', type=int, default=0, help='data loader num workers')   # num_workers=10(原版)
...
parser.add_argument('--attention_version', type=str, default='Wavelets')

parser.add_argument('--S4D_layer', type=int, default=2)
parser.add_argument('--prenorm', type=bool, default=False)
parser.add_argument('--k', type=int, default=8, help='multiwavelet-k')
parser.add_argument('--c', type=int, default=64, help='multiwavelet-c')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        # setting = '{}_{}_fourCroguidedm2TanhR_ab{}_modes{}_uwl{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(    # 未修改
        setting = '{}_{}_ab{}_modes{}_uwl{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
            args.model_id,
            args.model,
            args.ab,
            args.modes1,
